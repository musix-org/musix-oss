module.exports = function (msg, args, client, Discord, prefix, command) {
    ...
    if (!permissions.has('USE_EXTERNAL_EMOJIS')) return msg.channel.send('<:redx:674263474704220182> I cannot use external emojis, make sure I have the proper permissions!'); DEPRACATED!
    try {
        command.uses++;
